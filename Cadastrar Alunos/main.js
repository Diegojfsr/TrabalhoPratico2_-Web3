...
function insertUsuario(matricula,nome, nota1, nota2, nota3){
    const id = listaRegistros.ultimoIdGerado + 1;
    listaRegistros.ultimoIdGerado = id;
    listaRegistros.usuarios.push({
        id, matricula, nome, nota1, nota2, nota3
    })
    gravarBD()
    desenhar()
    vizualizar('lista')
...
function editUsuario(id, matricula,nome, nota1, nota2, nota3){
...
function submeter(e){
    ...
    if(data.id){
        editUsuario(data.id, data.matricula, data.nome, data.nota1, data.nota2, data.nota3)
    }else{
        insertUsuario( data.matricula, data.nome, data.nota1, data.nota2, data.nota3 )
    }
}
